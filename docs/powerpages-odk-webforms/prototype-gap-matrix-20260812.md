...
| P1 | CRDB enterprise readiness | Scalable MEL platform infrastructure, Microsoft resources, and permissions need CRDB review before pilot/handover planning. | `crdb-microsoft-resources-permissions-20260813.md` defines required enterprise architecture layers, Microsoft resources, and permission gates. | Review the CRDB resource/permission checklist with CRDB IT, SFU, reporting, risk, compliance, and enterprise architecture owners. | Confirmed owner/permission matrix or documented gaps. |
