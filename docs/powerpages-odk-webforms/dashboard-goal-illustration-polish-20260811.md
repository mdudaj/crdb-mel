...
- keep the supplied farmer illustration fully visible;
...
- changed `.goal-illustration` from `object-fit: cover` to `object-fit: contain`;
- kept `object-position: center bottom`;
