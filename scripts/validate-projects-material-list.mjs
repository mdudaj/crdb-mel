...
assertIncludes(viewSource, 'class="project-list-surface"', 'Projects route must group header, loading, list, and empty state inside one Material-style list surface.');
...
assertIncludes(viewSource, 'class="project-list-header"', 'Projects list must use the shared list header anatomy.');
assertIncludes(viewSource, 'class="project-list-count"', 'Projects list must show a visible assigned-project count chip.');
...
assertIncludes(viewSource, 'class="project-card__footer"', 'Projects cards must have a stable footer/action slot.');
...
assertIncludes(stylesSource, '.project-list-surface', 'Projects list surface styles must exist.');
assertIncludes(stylesSource, '.project-list-header', 'Projects list header styles must exist.');
assertIncludes(stylesSource, '.project-list-count', 'Projects list count chip styles must exist.');
...
assertIncludes(stylesSource, '.project-card__footer', 'Projects card footer styles must exist.');
