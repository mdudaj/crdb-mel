...
assertIncludes(viewSource, 'class="material-surface-header beneficiary-list__header"', 'Beneficiary list header must use the shared Material surface header class.');
assertIncludes(viewSource, 'class="material-count-chip beneficiary-list__count"', 'Beneficiary list count must use the shared Material count chip class.');
assertIncludes(viewSource, 'Search beneficiaries', 'Search control must have a visible label.');
assertIncludes(viewSource, 'class="beneficiary-table-wrap material-table"', 'Desktop record surface must use the shared Material table wrapper.');
...
assertIncludes(viewSource, 'class="material-row" tabindex="0"', 'Beneficiary desktop rows must use the shared Material row class.');
...
assertIncludes(viewSource, 'class="material-row beneficiary-record-card"', 'Beneficiary mobile cards must use the shared Material row class.');
assertIncludes(viewSource, 'class="material-card-footer"', 'Beneficiary mobile card footer must use the shared Material card footer class.');
