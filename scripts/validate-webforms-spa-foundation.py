...
def validate_powerpages_session_contract() -> None:
    ...
    for required in (
        ...
        "Monitoring sustainability outcomes and loan performance across Tanzania.",
        "managed-side-nav__logo",
        ":src=\"crdbLogoUrl\"",
        ...
        "Last updated: May 31, 2025 10:45 AM",
        "Data synced",
        "© 2025 CRDB Bank — Sustainable Finance Unit. All rights reserved.",
        "<ChevronDown",
