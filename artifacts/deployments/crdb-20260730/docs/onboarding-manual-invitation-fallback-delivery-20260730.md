...
The administrator must communicate the code and redemption URL only through an approved CRDB channel. This fallback is a controlled operational substitute for mailbox delivery, not a public or collector-facing feature.
