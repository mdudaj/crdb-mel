...
namespace Tacatdp.ReportingProjection.Plugin
{
    ...
    public abstract class PluginBase : IPlugin
    {
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            {
                localPluginContext.Trace($"Dataverse fault. code={orgServiceFault.Detail.ErrorCode} correlation={localPluginContext.PluginExecutionContext.CorrelationId}");

                throw new InvalidPluginExecutionException("Projection refresh failed during a Dataverse operation. See the correlated System Job and plug-in trace.", orgServiceFault);
            }
            finally
            {
