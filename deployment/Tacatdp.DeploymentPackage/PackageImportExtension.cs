...
namespace Tacatdp.DeploymentPackage
{
    ...
    public class PackageImportExtension : ImportExtension
    {
        ...
        public override string GetNameOfImport(bool plural) => plural ? "TACATDP deployments" : "TACATDP deployment";

        /// <summary>
        /// Long name of the Import Package.
        /// </summary>
        public override string GetLongNameOfImport => "TACATDP Impact Tracking Prototype 0.2.2.0";

        /// <summary>
        /// Description of the package, used in the package selection UI
        /// </summary>
        public override string GetImportPackageDescriptionText =>
            "Imports the managed TACATDP solution and idempotently seeds its project, form, published form version, portal assignment, and XForm file.";
        ...
        public override bool AfterPrimaryImport()
        {
            ...
            {
                throw new InvalidOperationException("Unable to resolve the extracted deployment package directory.");
            }
